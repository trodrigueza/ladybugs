...
urlpatterns = [
    ...
    path('entrenador/rutina/<int:rutina_id>/add/', views_entrenador.ajax_agregar_ejercicio, name='ajax_agregar_ejercicio'),
    path('entrenador/rutina/<int:rutina_id>/eliminar/', views_entrenador.ajax_eliminar_ejercicio, name='ajax_eliminar_ejercicio'),
    path('entrenador/rutina/<int:rutina_id>/limpiar/', views_entrenador.ajax_limpiar_dia, name='ajax_limpiar_dia'),
    path('entrenador/rutina/<int:rutina_id>/asignar/', views_entrenador.ajax_asignar_rutina, name='ajax_asignar_rutina'),
    ...
    path('entrenador/ejercicios/nuevo/', views_entrenador.ajax_crear_ejercicio, name='ajax_crear_ejercicio'),

    # AJAX actualizar asignación (series/reps/peso/tempo)
    path('entrenador/asignacion/<int:asignacion_id>/actualizar/', views_entrenador.actualizar_ejercicio_ajax, name='ajax_actualizar_ejercicio'),

    # Borrar rutina completa
    path('entrenador/rutina/<int:rutina_id>/borrar/', views_entrenador.borrar_rutina_view, name='borrar_rutina'),
]
